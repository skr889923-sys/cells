...
export const LeftPanel: React.FC<LeftPanelProps> = ({ activeCell, onOpenMicroscope, onOpenCompare }) => {
  return (
    <div className="floating-panel left-panel">
      <div className="cell-brief glass-panel" style={{ maxWidth: '400px' }}>
        ...
        <div className="credit-line" style={{ marginTop: '1rem', fontSize: '0.9rem', color: 'var(--color-primary)', fontWeight: 600 }}>
          فكرة وتطوير : أ. هيثم الزهراني
        </div>
      </div>

      <div className="left-actions" style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginTop: '1rem', maxWidth: '350px' }}>
